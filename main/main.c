...
static const char *TAG = "UART_FULL_DUPLEX";

// ==== پیکربندی UART را اینجا تعیین کنید ====
...
void app_main(void)
{
    ...
    vTaskDelay(3000);
     const uart_config_t uart_config = {
        ...
        .flow_ctrl = UART_HW_FLOWCTRL_DISABLE,   // بدون RTS/CTS
    ...
    xTaskCreate(uart_tx_task, "uart_tx_task", 4096, NULL, 9,  NULL);

    ESP_LOGI(TAG, "UART full-duplex started on TX=%d RX=%d @ %d baud", UART_TXD_PIN, UART_RXD_PIN, UART_BAUD_RATE);
}
