...
void Send_Command_For_Music_Player(uint16_t CommandNumber){
    ...
    case ESP_AVRC_PT_CMD_FORWARD:   // آهنگ بعد
    ...
    case ESP_AVRC_PT_CMD_BACKWARD:  // آهنگ قبل
    ...
    case ESP_AVRC_PT_CMD_MUTE:
        esp_avrc_ct_send_passthrough_cmd(0, ESP_AVRC_PT_CMD_MUTE, ESP_AVRC_PT_CMD_STATE_PRESSED);
        esp_avrc_ct_send_passthrough_cmd(0, ESP_AVRC_PT_CMD_MUTE, ESP_AVRC_PT_CMD_STATE_RELEASED);
        break;
    ...
    default:
        ESP_LOGI("AVRCP", "Command 0x%x not implemented in switch", CommandNumber);
        break;
    }
}
static void volume_set_by_local_host(uint8_t volume)
